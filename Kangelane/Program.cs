...
class Kangelane
{
    ...
    {
        return ("Typical hero suit");
    }
    public virtual string Tervitus()
    {
        return ($"Helo from {nimi}");
    }
...
class SuperKangelane : Kangelane
{
    ...
    {
        return "Super hero costume";
    }
    public override string Tervitus()
    {
        return $"Greating from super hero - {Nimi}";
    }
    public override string MissiooniStaatus()
    {
        return "Sory but i can't help right now ";
    }
    public override string ToString()
    {
...
class Program
{
    ...
    public static void LoeKangelasedFailist()
    {
        ...
        try
        {
            string path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "C:\\Users\\ADMIN\\source\\repos\\Kangelane\\Kangelane\\Kangelane\\andmed.txt");
            char symbol = '/';
